...
public class QuickStart {
    ...
    final static StringBuilder jeffFaceImageFolderPath = new StringBuilder(resourcesPath + "\\jeff");
    ...
    final static File jeffFaceImageFolder = new File(jeffFaceImageFolderPath.toString());
    ...
    public static void main(String args[]) {
        ...
        Thread recognitionThread = new Thread(new Runnable() {
            @Override
            public void run() {
                recognition(jeffFaceDBPath + ".faceDB");
            }
        });
    ...
    public static String getFaceDBPath(String name) {
        ...
        switch (name.toLowerCase()) {
            ...
            case "jerry":
                ...
                break;
            case "jeff":
                faceDB = jeffFaceDBPath.toString();
                break;
            default:
                break;
        }
    ...
    public static List<String> getFaceImageFolder(String name) {
        ...
        switch (name.toLowerCase()) {
            ...
            case "jerry":
                ...
                break;
            case "jeff":
                imagePathList = folderUtil.listPath(jeffFaceImageFolder);
            default:
                break;
        }
